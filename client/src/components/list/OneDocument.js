              ...
              <table>
                <tr key={this.props.match.params.id}>
                  ...
                  <tr>
                    ...
                    <i>{this.state.publisherAddress}</i>
                  </tr>
                  <tr>
                    <b>Edition: </b>
                    <i>{this.state.edition}</i>
                  </tr>
                  <tr>
                    <b>Volume: </b>
                    <i>{this.state.volume}</i>
                  </tr>
                  <tr>
                    <b>Editor: </b>
                    <i>{this.state.editor}</i>
                  </tr>
                  <tr>
                    <b>DOI: </b>
                    <i>{this.state.doi}</i>
                  ...
                  <tr>
                    <b>Institution: </b>
                    <i>{this.state.institution}</i>
                  </tr>
                  <tr>
                    <b>Organization: </b>
                    <i>{this.state.organization}</i>
                  </tr>
                  <tr>
                    <b>Chapter: </b>
                    <i>{this.state.chapter}</i>
                  </tr>
                  <tr>
                    <b>School: </b>
                    <i>{this.state.school}</i>
                  </tr>
                  <tr>
                    <b>Crossref: </b>
                    <i>{this.state.crossref}</i>
                  </tr>
                  <tr>
                    <b>Series: </b>
                    <i>{this.state.series}</i>
                  </tr>
                  <tr>
                    <b>Note: </b>
                    <i>{this.state.note}</i>
                  ...
                  <tr>
                    <b>Author Address: </b>
                    <i>{this.state.authorAddress}</i>
                  </tr>
                  <tr>
                    <b>Place Published: </b>
                    <i>{this.state.placePublished}</i>
                  </tr>
                  <tr>
                    <b>Keywords: </b>
                    <i>{this.state.keywords}</i>
                  </tr>
                  <tr>
                    <b>Language: </b>
                    <i>{this.state.language}</i>
                  </tr>
                  <tr>
                    <b>Number Of Volumes: </b>
                    <i>{this.state.numberOfVolumes}</i>
                  </tr>
                  <tr>
                    <b>ISBN: </b>
                    <i>{this.state.ISBN}</i>
